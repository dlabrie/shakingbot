...
### Telegram ###
uxiosTelegramOpt = "Would you like to receive notifications via " + '\033[94m' + "Telegram" + '\033[0m' + " when a successful shake occurs?"
...
uxiosExistingTelegramAPI = "It seems you already have previously entered " + '\033[94m' + "Telegram" + '\033[0m' + " bot details.\nIf you wish to change the API details, delete creds/.telegramAPIToken & creds/.telegramChatID to force this.\n"

### Discord ###
uxiosDiscordOpt = "Would you like to receive notifications via " + '\033[92m' + "Discord" + '\033[0m' + " when a successful shake occurs?"
...
uxiosExistingDiscordWebhook = "It seems you already have previously entered " + '\033[92m' + "Discord" + '\033[0m' + " bot details.\nIf you wish to change the webhook URL, delete creds/.discordWebhook to force this.\n"
